...
const VALIDATE_PASSWORD_E002 =
  "Mật khẩu tối thiểu 6 kí tự, có chứa chữ hoa, chữ thường và kí tự số";
const VALIDATE_CONFIRMPASSWORD_E001 = "Vui lòng nhập xác nhận mật khẩu";
const VALIDATE_CONFIRMPASSWORD_E002 =
...
const MAKE_RESERVATION_E001 = "Không đủ bàn! Hãy thử loại bàn khác!";
